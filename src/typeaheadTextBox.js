...
var typeaheadInitialize = function() {
    ...
    $('#field-work .typeahead').typeahead({
        hint: true,
        highlight: true,
        minLength: 1
    },
    ...
    // For counties
    var counties = ['Autauga County, Alabama', 
    ...
    // Add or remove a new set of transit and mileage inputs
    $('.add-more').click(function(e){
        ...
        $('.remove-me').unbind().click(function(e){
            ...
            // removes remove button if only one set of inputs left
            if (next == 1) {
                $('.remove-me').remove();
                removeCheck = true;
            }
    ...
    // Add or remove a new set of work inputs
    $('.add-more-two').click(function(e){
        e.preventDefault();
